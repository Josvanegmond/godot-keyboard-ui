...
You can find an example scene using the modal control node that implements the focus_control node in [examples/modal_trap](https://github.com/Josvanegmond/godot-keyboard-ui/tree/main/examples/modal_trap)